...
package com.company.farmerpocket.adapter.baserecycler;
...
import com.company.farmerpocket.adapter.baserecycler.animation.AlphaInAnimation;
import com.company.farmerpocket.adapter.baserecycler.animation.BaseAnimation;
import com.company.farmerpocket.adapter.baserecycler.animation.ScaleInAnimation;
import com.company.farmerpocket.adapter.baserecycler.animation.SlideInBottomAnimation;
import com.company.farmerpocket.adapter.baserecycler.animation.SlideInLeftAnimation;
import com.company.farmerpocket.adapter.baserecycler.animation.SlideInRightAnimation;
...
public abstract class BaseQuickAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private BaseViewHolder getLoadingView(ViewGroup parent) {
        if (mLoadingView == null) {
            return createBaseViewHolder(parent, R.layout.base_recycler_load_more);
        }
