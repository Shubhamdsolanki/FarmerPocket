package com.company.farmerpocket.component.refreshload;
...
import com.company.farmerpocket.component.refreshload.pullableview.Pullable;
 ...
 * PullToRefreshLayout
 * 自定义的布局，用来管理三个子控件，
 * 其中一个是下拉头，一个是包含内容的pullableView（可以是实现Pullable接口的的任何View），还有一个上拉头
 */
public class PullToRefreshLayout extends RelativeLayout {
    ...
    private void initView(Context context) {
        ...
        rotateAnimation = (RotateAnimation) AnimationUtils.loadAnimation(
                context, R.anim.pull_to_refresh_reverse_anim);
        refreshingAnimation = (RotateAnimation) AnimationUtils.loadAnimation(
                context, R.anim.pull_to_refresh_rotating_anim);
        // 添加匀速转动动画
